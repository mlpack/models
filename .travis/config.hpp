...
//// Uncomment the above line if you have LAPACK or a high-speed replacement for
////  LAPACK, such as Intel's MKL, AMD's ACML, or the Accelerate framework.
...
//// BLAS, such as GotoBLAS, Intel's MKL, AMD's ACML, or the Accelerate
//// framework.
...
//// and/or BLAS (eg. -llapack -lblas) instead of linking indirectly with LAPACK
//// and/or BLAS via Armadillo's run-time wrapper library.

// #define ARMA_BLAS_CAPITALS
//// Uncomment the above line if your BLAS and LAPACK libraries have capitalised
//// function names (eg. ACML on 64-bit Windows)

#define ARMA_BLAS_UNDERSCORE
//// Uncomment the above line if your BLAS and LAPACK libraries have function
//// names with a trailing underscore. Conversely, comment it out if the
//// function names don't have a trailing underscore.
...
//// Uncomment the above line if you want to use Intel TBB scalable_malloc() and
//// scalable_free() instead of standard new[] and delete[]
...
//// Your machine and compiler must have support for 64 bit integers
//// (eg. via "long" or "long long")

#if !defined(ARMA_USE_CXX11)
#define ARMA_USE_CXX11
//// Uncomment the above line if you have a C++ compiler that supports C++11
//// This will enable additional features, such as use of initialiser lists
#endif

#if !defined(ARMA_USE_HDF5)
/* #undef ARMA_USE_HDF5 */
//// Uncomment the above line if you want the ability to save and load matrices
//// stored in the HDF5 format; the hdf5.h header file must be available on your
//// system and you will need to link with the hdf5 library (eg. -lhdf5)
#endif
...
#endif
//// This is the minimum increase in the amount of memory (in terms of elements)
//// allocated by a sparse matrix; it must be an integer that is at least 1.
//// The minimum recommended size is 16.

// #define ARMA_NO_DEBUG
//// Uncomment the above line if you want to disable all run-time checks.
//// This will result in faster code, but you first need to make sure that your
//// code runs correctly! We strongly recommend to have the run-time checks
//// enabled during development, as this greatly aids in finding mistakes in
//// your code, and hence speeds up development. We recommend that run-time
//// checks be disabled _only_ for the shipped version of your program.
